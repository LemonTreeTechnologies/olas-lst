...
/// @dev Green-light check for Base pool 0xB14Cd66c before any capital moves.
///
...
contract BaseB14CDeliveryForkTest is Test {
    ...
    address constant POOL = 0xB14Cd66c6c601230EA79fa7Cc072E5E0C2F3A756;
    uint256 constant AGENT_ID = 103;

    ExternalStakingDistributor internal esd;
    uint256 internal agentPk = 0xB14C;
    ...
    function test_B14C_oneSeat_stakeDeliverEarn() public {
        if (_skip()) return;
        _setUpFork();
