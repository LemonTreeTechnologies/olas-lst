...
echo "${green}Deposit OLAS for external staking on specified chains${reset}"
castArgs="$depositoryProxyAddress depositExternal(uint256[],uint256[],bytes[],uint256[]) $chainIds $amounts $bridgePayloads $values"
echo $castArgs
