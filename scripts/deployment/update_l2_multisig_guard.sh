...
echo "${green}Updating MultisigGuard implementation in MultisigGuardProxy${reset}"
castSendHeader="cast send --rpc-url $networkURL$API_KEY $walletArgs"
castArgs="$multisigGuardProxyAddress changeImplementation(address) $multisigGuardAddress"
echo $castArgs
