...
echo "${green}Updating ExternalStakingDistributor implementation in ExternalStakingDistributorProxy${reset}"
castSendHeader="cast send --rpc-url $networkURL$API_KEY $walletArgs"
castArgs="$externalStakingDistributorProxyAddress changeImplementation(address) $externalStakingDistributorAddress"
echo $castArgs
