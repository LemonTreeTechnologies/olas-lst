...
/// @title StakingBaseV1 - V1 of base abstract smart contract for staking a service by its owner
abstract contract StakingBaseV1 is ERC721TokenReceiver {
    enum StakingState {
        Unstaked,
        Staked,
        Evicted
    ...
    /// @dev StakingBaseV1 initialization.
...
/// @title StakingTokenV1 - V1 smart contract for staking a service by its owner when the service has an ERC20 token as the deposit
contract StakingTokenV1 is StakingBaseV1 {
